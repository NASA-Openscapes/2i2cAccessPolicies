...
team_names <- c("longterm-access-2i2c", "2024-mentors", "2024-science-teams", "2024-nmfs-champions-cohort", "2024-coastwatch")
...
size_by_date_by_team <- size_by_date |>
  ...
  mutate(
    team = case_when(
      is.na(team) & directory %in% c("_shared", "deployment-service-check") ~ "shared",
      is.na(team) ~ "No team",
      .default = team
    ),
